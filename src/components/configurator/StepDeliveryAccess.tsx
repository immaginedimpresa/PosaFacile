                                ...
                                <div className="p-4 bg-amber-50/80 rounded-xl border border-amber-200 flex items-start gap-3 text-xs sm:text-sm text-amber-950">
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        <p className="text-amber-800 text-xs leading-relaxed">
                                            I bancali vengono lasciati {isStreet ? 'sul ciglio della strada a livello terra' : 'all&apos;interno del garage/box'}. Nel passaggio successivo indicheremo il piano dell&apos;immobile e chi effettuerà la salita.
                                        </p>
                                    </div>
                                </div>
                            ) : (
                    ...
                    {deliverySubStep === 2 && (
                        <div className="space-y-5">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                                ...
                                >
                                    <div className={`w-9 h-9 rounded-xl flex items-center justify-center shrink-0 ${
                                        isGround ? 'bg-stone-800 text-white' : 'bg-white text-stone-600 border border-stone-200'
                                    }`}>
