...
import { Truck, Building2, Package, Home, CheckCircle2, AlertCircle, Info, ShieldCheck } from 'lucide-react'
        ...
        <div className="space-y-6">
            <div>
                <p className="text-gray-500">
                    I colli di piastrelle e i sacchi di colla sono materiali pesanti su bancale: definisci dove scaricare la fornitura e come accedere al cantiere.
                </p>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-stone-200 p-6 sm:p-7 space-y-6 shadow-xs">
                <div className="flex items-center justify-between border-b border-stone-100 pb-4">
                    <div className="flex items-center gap-2.5">
                        ...
                        <div>
                            <h3 className="font-bold text-stone-900 text-base">Modalità di Scarico e Consegna</h3>
                            <p className="text-xs text-stone-500">Scegli la soluzione più adatta ed economica per il tuo cantiere</p>
                        </div>
                    </div>
                    {breakdown.total > 0 ? (
